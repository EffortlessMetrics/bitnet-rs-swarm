...
The A770 lane is useful but still diagnostic. A770-125 extends the focused
QK256 replay packet from fifty-eight runnable Q/K/V targets to fifty-nine:
the layer-0 through layer-18 Q/K/V trios plus layer-19 `q_proj` and `k_proj`
...
1. The current proof is too narrow.
   ...
   A770-125 covers fifty-nine focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-18 Q/K/V trios plus layer-19 `q_proj`
...
After A770-125, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-19 `v_proj`, or the next remaining
