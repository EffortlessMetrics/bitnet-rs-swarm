...
The A770 lane is useful but still diagnostic. A770-111 extends the focused
QK256 replay packet from forty-four runnable Q/K/V targets to forty-five: the
layer-0 through layer-14 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-111 covers forty-five focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-14 Q/K/V trios.
...
After A770-111, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-15 `q_proj`, or the next remaining
