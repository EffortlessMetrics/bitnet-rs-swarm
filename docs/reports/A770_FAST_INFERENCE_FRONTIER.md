...
The A770 lane is useful but still diagnostic. A770-143 extends the focused
QK256 replay packet from seventy-six runnable Q/K/V targets to seventy-seven:
the layer-0 through layer-24 Q/K/V trios plus layer-25 `q_proj` and `k_proj`
...
1. The current proof is too narrow.
   ...
   A770-143 covers seventy-seven focused Q/K/V rows for one case and one first
...
After A770-143, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-25 `v_proj`, or the next remaining
