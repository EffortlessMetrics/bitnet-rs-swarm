...
The A770 lane is useful but still diagnostic. A770-121 extends the focused
QK256 replay packet from fifty-four runnable Q/K/V targets to fifty-five: the
layer-0 through layer-17 Q/K/V trios plus layer-18 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-121 covers fifty-five focused Q/K/V rows for one case and one first
...
After A770-121, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-18 `k_proj`, or the next remaining
