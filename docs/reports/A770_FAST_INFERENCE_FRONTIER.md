...
The A770 lane is useful but still diagnostic. A770-148 extends the focused
QK256 replay packet from eighty-one runnable Q/K/V targets to eighty-two: the
layer-0 through layer-26 Q/K/V trios plus layer-27 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-148 covers eighty-two focused Q/K/V rows for one case and one first
...
After A770-148, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-27 `k_proj`, or the next remaining
