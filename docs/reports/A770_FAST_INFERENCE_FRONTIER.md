...
The A770 lane is useful but still diagnostic. A770-072 extends the focused
QK256 replay packet from five runnable Q/K/V targets to six: the layer-0
Q/K/V trio and the layer-1 Q/K/V trio for the committed summary-logits first
...
1. The current proof is too narrow.
   ...
   A770-072 covers six focused Q/K/V rows for one case and one first mismatch:
   the layer-0 and layer-1 Q/K/V trios. Fast inference needs the same kind of
...
After A770-072, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-2 `q_proj`, or the next remaining
