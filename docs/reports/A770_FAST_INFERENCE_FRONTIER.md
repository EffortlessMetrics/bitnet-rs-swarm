...
The A770 lane is useful but still diagnostic. A770-114 extends the focused
QK256 replay packet from forty-seven runnable Q/K/V targets to forty-eight: the
layer-0 through layer-15 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-114 covers forty-eight focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-15 Q/K/V trios.
...
After A770-114, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-16 `q_proj`, or the next remaining
