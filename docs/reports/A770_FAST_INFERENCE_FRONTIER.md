...
The A770 lane is useful but still diagnostic. A770-102 extends the focused
QK256 replay packet from thirty-five runnable Q/K/V targets to thirty-six:
the layer-0 through layer-11 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-102 covers thirty-six focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-11 Q/K/V trios. Fast inference needs the
...
After A770-102, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-12 `q_proj`, or the next remaining
