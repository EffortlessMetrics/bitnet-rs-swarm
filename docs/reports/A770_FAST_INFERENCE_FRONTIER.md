...
The A770 lane is useful but still diagnostic. A770-105 extends the focused
QK256 replay packet from thirty-eight runnable Q/K/V targets to thirty-nine:
the layer-0 through layer-12 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-105 covers thirty-nine focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-12 Q/K/V trios. Fast inference needs the
   same kind of selected-device confidence
...
After A770-105, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-13 `q_proj`, or the next remaining
