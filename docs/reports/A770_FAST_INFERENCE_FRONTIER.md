...
The A770 lane is useful but still diagnostic. A770-123 extends the focused
QK256 replay packet from fifty-six runnable Q/K/V targets to fifty-seven: the
layer-0 through layer-18 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-123 covers fifty-seven focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-18 Q/K/V trios.
...
After A770-123, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-19 `q_proj`, or the next remaining
