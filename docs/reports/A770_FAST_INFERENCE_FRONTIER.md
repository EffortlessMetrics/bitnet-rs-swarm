...
The A770 lane is useful but still diagnostic. A770-153 extends the focused
QK256 replay packet from eighty-six runnable Q/K/V targets to eighty-seven: the
layer-0 through layer-28 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-153 covers eighty-seven focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-28 Q/K/V trios.
...
After A770-153, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-29 `q_proj`, or the next remaining
