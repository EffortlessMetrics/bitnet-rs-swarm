...
The A770 lane is useful but still diagnostic. A770-141 extends the focused
QK256 replay packet from seventy-four runnable Q/K/V targets to seventy-five:
the layer-0 through layer-23 Q/K/V trios plus the complete layer-24 Q/K/V trio
...
1. The current proof is too narrow.
   ...
   A770-141 covers seventy-five focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-23 Q/K/V trios plus the complete
   layer-24 Q/K/V trio.
...
After A770-141, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-25 `q_proj`, or the next remaining
