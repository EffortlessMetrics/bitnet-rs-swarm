...
The A770 lane is useful but still diagnostic. A770-151 extends the focused
QK256 replay packet from eighty-four runnable Q/K/V targets to eighty-five: the
layer-0 through layer-27 Q/K/V trios plus layer-28 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-151 covers eighty-five focused Q/K/V rows for one case and one first
...
After A770-151, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-28 `k_proj`, or the next remaining
