...
The A770 lane is useful but still diagnostic. A770-135 extends the focused
QK256 replay packet from sixty-eight runnable Q/K/V targets to sixty-nine: the
layer-0 through layer-22 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-135 covers sixty-nine focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-22 Q/K/V trios. Fast inference needs the
...
After A770-135, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-23 `q_proj`, or the next remaining
