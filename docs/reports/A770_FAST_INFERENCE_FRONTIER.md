...
The A770 lane is useful but still diagnostic. A770-115 extends the focused
QK256 replay packet from forty-eight runnable Q/K/V targets to forty-nine: the
layer-0 through layer-15 Q/K/V trios plus layer-16 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-115 covers forty-nine focused Q/K/V rows for one case and one first
...
After A770-115, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-16 `k_proj`, or the next remaining
