...
The A770 lane is useful but still diagnostic. A770-132 extends the focused
QK256 replay packet from sixty-five runnable Q/K/V targets to sixty-six: the
layer-0 through layer-21 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-132 covers sixty-six focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-21 Q/K/V trios.
...
After A770-132, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-22 `q_proj`, or the next remaining
