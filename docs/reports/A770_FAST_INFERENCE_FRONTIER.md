...
The A770 lane is useful but still diagnostic. A770-099 extends the focused
QK256 replay packet from thirty-two runnable Q/K/V targets to thirty-three: the
layer-0 through layer-10 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-099 covers thirty-three focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-10 Q/K/V trios.
...
After A770-099, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-11 `q_proj`, or the next remaining
