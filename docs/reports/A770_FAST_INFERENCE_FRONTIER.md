...
The A770 lane is useful but still diagnostic. A770-147 extends the focused
QK256 replay packet from eighty runnable Q/K/V targets to eighty-one: the
layer-0 through layer-26 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-147 covers eighty-one focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-26 Q/K/V trios.
...
After A770-147, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-27 `q_proj`, or the next remaining
