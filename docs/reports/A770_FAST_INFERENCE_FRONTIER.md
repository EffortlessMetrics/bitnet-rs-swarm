...
The A770 lane is useful but still diagnostic. A770-082 extends the focused
QK256 replay packet from fifteen runnable Q/K/V targets to sixteen: the layer-0
through layer-4 Q/K/V trios plus layer-5 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-082 covers sixteen focused Q/K/V rows for one case and one first
...
After A770-082, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-5 `k_proj`, or the next remaining
