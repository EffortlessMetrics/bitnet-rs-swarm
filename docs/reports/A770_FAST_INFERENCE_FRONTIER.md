...
The A770 lane is useful but still diagnostic. A770-108 extends the focused
QK256 replay packet from forty-one runnable Q/K/V targets to forty-two: the
layer-0 through layer-13 Q/K/V trios for the committed summary-logits first
mismatch.
...
1. The current proof is too narrow.
   ...
   A770-108 covers forty-two focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-13 Q/K/V trios. Fast inference needs the
   same kind of selected-device
...
After A770-108, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-14 `q_proj`, or the next remaining
