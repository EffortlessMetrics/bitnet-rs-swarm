...
The A770 lane is useful but still diagnostic. A770-112 extends the focused
QK256 replay packet from forty-five runnable Q/K/V targets to forty-six: the
layer-0 through layer-14 Q/K/V trios plus layer-15 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-112 covers forty-six focused Q/K/V rows for one case and one first
...
After A770-112, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-15 `k_proj`, or the next remaining
