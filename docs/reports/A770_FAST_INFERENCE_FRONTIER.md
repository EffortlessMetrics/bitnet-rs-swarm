...
The A770 lane is useful but still diagnostic. A770-101 extends the focused
QK256 replay packet from thirty-four runnable Q/K/V targets to thirty-five:
the layer-0 through layer-10 Q/K/V trios plus layer-11 `q_proj` and `k_proj`
...
1. The current proof is too narrow.
   ...
   A770-101 covers thirty-five focused Q/K/V rows for one case and one first
   ...
   confidence across the remaining Q/K/V/O
...
After A770-101, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-11 `v_proj`, or the next remaining
