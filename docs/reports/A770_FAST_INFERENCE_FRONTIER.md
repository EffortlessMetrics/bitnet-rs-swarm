...
The A770 lane is useful but still diagnostic. A770-133 extends the focused
QK256 replay packet from sixty-six runnable Q/K/V targets to sixty-seven: the
layer-0 through layer-21 Q/K/V trios plus layer-22 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-133 covers sixty-seven focused Q/K/V rows for one case and one first
   mismatch: the layer-0 through layer-21 Q/K/V trios plus layer-22 `q_proj`.
...
After A770-133, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-22 `k_proj`, or the next remaining
