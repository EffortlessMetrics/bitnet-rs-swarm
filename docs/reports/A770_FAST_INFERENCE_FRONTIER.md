...
The A770 lane is useful but still diagnostic. A770-127 extends the focused
QK256 replay packet from sixty runnable Q/K/V targets to sixty-one: the
layer-0 through layer-19 Q/K/V trios plus layer-20 `q_proj` for the committed
...
1. The current proof is too narrow.
   ...
   A770-127 covers sixty-one focused Q/K/V rows for one case and one first
...
After A770-127, the next honest step is one more focused replay target, not a
speed PR: capture and replay layer-20 `k_proj`, or the next remaining
