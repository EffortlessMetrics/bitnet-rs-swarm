# A770-038 Pre-Antepenultimate Block Source Frontier

## Scope

A770-038 adds a diagnostic-only pre-antepenultimate transformer block source
...
```text
generated_output_pre_antepenultimate_block_source_frontier.classification =
...
pre_antepenultimate_block_source_context_available = true
...
block_input_rms_abs_delta = 29.30395655884149
attention_output_rms_abs_delta = 22.976187056946344
post_attention_residual_rms_abs_delta = 47.85499331061328
feed_forward_output_rms_abs_delta = 12.672925729987242
block_output_rms_abs_delta = 60.3220771044771
...
The focused generated-output mismatch is already present at the
pre-antepenultimate transformer block input. A770-038 therefore keeps routing
upstream instead of promoting any attention, FFN, residual-add, QK256, OpenCL,
or runtime math fix from this evidence.
