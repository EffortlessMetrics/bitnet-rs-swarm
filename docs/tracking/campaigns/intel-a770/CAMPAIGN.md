...
| A770-091 | in_progress | Converts layer-8 `q_proj` into selected-device A770 OpenCL replay beyond A770-090, executing twenty-five Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
