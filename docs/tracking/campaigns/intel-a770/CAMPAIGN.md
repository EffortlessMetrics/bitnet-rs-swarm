...
| A770-074 | in_progress | Converts layer-2 `k_proj` into selected-device A770 OpenCL replay beyond A770-073, executing eight Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
