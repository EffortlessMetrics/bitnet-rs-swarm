...
| A770-118 | in_progress | Captured layer-17 `q_proj` as the next selected-device A770 OpenCL replay target beyond A770-117, executing fifty-two Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
