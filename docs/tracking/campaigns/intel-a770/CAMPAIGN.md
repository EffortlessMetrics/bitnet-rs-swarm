...
| A770-114 | in_progress | Captured layer-15 `v_proj` as the next selected-device A770 OpenCL replay target beyond A770-113, executing forty-eight Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
