...
| A770-110 | in_progress | Captured layer-14 `k_proj` as the next selected-device A770 OpenCL replay target beyond A770-109, executing forty-four Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
