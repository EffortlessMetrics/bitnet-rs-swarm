...
| A770-125 | in_progress | Captured layer-19 `k_proj` as the next selected-device A770 OpenCL replay target beyond A770-124, executing fifty-nine Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
