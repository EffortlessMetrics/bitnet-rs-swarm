...
| A770-087 | in_progress | Converts layer-6 `v_proj` into selected-device A770 OpenCL replay beyond A770-086, executing twenty-one Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
