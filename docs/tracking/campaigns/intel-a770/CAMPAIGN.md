...
| A770-075 | in_progress | Converts layer-2 `v_proj` into selected-device A770 OpenCL replay beyond A770-074, executing nine Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
