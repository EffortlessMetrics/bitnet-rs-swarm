...
| A770-083 | in_progress | Convert layer-5 `k_proj` into selected-device A770 OpenCL replay beyond A770-082, executing seventeen Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
