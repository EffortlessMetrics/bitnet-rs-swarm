...
| A770-120 | in_progress | Captured layer-17 `v_proj` as the next selected-device A770 OpenCL replay target beyond A770-119, executing fifty-four Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
