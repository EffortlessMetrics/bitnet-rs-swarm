...
| A770-071 | in_progress | Convert layer-1 `k_proj` into selected-device A770 OpenCL replay with fallback_used=false, keeping the proof to one case, one mismatch, one kernel family, and one newly runnable target beyond A770-070. |
