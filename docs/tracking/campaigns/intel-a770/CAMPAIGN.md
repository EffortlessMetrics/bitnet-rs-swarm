...
| A770-089 | in_progress | Convert layer-7 `k_proj` into selected-device A770 OpenCL replay beyond A770-088, executing twenty-three Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
