...
| A770-062 | ready | Capture diagnostic production replay instrumentation for adjusted-dot, scale, reciprocal-path, final-value, and store bits before any production QK256 policy change. |
