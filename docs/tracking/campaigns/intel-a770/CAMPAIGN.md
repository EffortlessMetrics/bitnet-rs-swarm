...
| A770-115 | in_progress | Captured layer-16 `q_proj` as the next selected-device A770 OpenCL replay target beyond A770-114, executing forty-nine Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
