...
| A770-109 | in_progress | Converts layer-14 `q_proj` into selected-device A770 OpenCL replay beyond A770-108, executing forty-three Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
