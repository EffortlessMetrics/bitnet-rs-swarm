...
| A770-102 | in_progress | Recording layer-11 `v_proj` as the next selected-device A770 OpenCL replay target beyond A770-101, executing thirty-six Q/K/V targets with fallback_used=false while all promotion, residency, speed, and full-inference claims remain closed. |
