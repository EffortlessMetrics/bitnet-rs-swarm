...
| A770-124 | in_progress | Captured layer-19 `q_proj` as the next selected-device A770 OpenCL replay target beyond A770-123, executing fifty-eight Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
