...
| A770-096 | ready | Convert layer-9 `v_proj` into the next selected-device A770 OpenCL replay target beyond A770-095, keeping the proof one target wide and all promotion, residency, speed, and full-inference claims closed. |
