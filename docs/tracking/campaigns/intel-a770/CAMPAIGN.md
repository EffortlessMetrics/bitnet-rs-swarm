...
| A770-076 | in_progress | Converts layer-3 `q_proj` into selected-device A770 OpenCL replay beyond A770-075, executing ten Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
