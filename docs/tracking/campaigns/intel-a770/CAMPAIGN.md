...
| A770-078 | in_progress | Converts layer-3 `v_proj` into selected-device A770 OpenCL replay beyond A770-077, executing twelve Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
