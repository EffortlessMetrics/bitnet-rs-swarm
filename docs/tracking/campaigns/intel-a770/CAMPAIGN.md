...
| A770-107 | in_progress | Convert layer-13 `k_proj` into the next selected-device A770 OpenCL replay target beyond A770-106, executing forty-one Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
