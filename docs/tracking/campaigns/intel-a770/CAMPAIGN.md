...
| A770-104 | in_progress | Convert layer-12 `k_proj` into selected-device A770 OpenCL replay beyond A770-103, executing thirty-eight Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
