...
| A770-073 | in_progress | Converts layer-2 `q_proj` into selected-device A770 OpenCL replay beyond A770-072, executing seven Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
