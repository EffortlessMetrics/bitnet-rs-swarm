...
| A770-121 | in_progress | Captures layer-18 `q_proj` as the next selected-device A770 OpenCL replay target beyond A770-120, executing fifty-five Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
