...
| A770-088 | pr_open | #1364 converts layer-7 `q_proj` into selected-device A770 OpenCL replay beyond A770-087, executing twenty-two Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
