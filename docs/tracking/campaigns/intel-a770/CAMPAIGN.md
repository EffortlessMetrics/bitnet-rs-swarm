...
| A770-093 | in_progress | Converts layer-8 `v_proj` into selected-device A770 OpenCL replay beyond A770-092, executing twenty-seven Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
