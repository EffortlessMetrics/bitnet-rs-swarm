...
| A770-099 | pr_open | #1401 converts layer-10 `v_proj` into selected-device A770 OpenCL replay beyond A770-098; the receipt executes thirty-three Q/K/V targets with fallback_used=false and keeps all promotion, residency, speed, and full-inference claims closed. |
