...
| A770-111 | pr_open | #1427 captured layer-14 `v_proj` as the next selected-device A770 OpenCL replay target beyond A770-110, executing forty-five Q/K/V targets with fallback_used=false while keeping all promotion, residency, speed, and full-inference claims closed. |
