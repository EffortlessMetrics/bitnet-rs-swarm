...
| SLM-CPU-088 | ready | Queue the implementation or machine-checkable blocker slice for the residual-add / `transformer.block.output` allocation-layout boundary; any runtime change must preserve the Qwen3 Q8_0 appliance oracle and cannot claim speedup, packed-Q8 promotion, Q4/Q5, accelerators, server, Qwen3.5, or BitNet QK256 changes without before/after receipts. |
