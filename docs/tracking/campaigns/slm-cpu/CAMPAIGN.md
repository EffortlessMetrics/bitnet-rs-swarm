...
| SLM-CPU-085 | ready | Next target after #399: further narrow the final-norm/layer-output caller-output-storage boundary while preserving the Qwen3 Q8_0 appliance behavior oracle before any bounded allocation improvement can be claimed. |
