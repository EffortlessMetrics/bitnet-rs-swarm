...
| SLM-CPU-088 | pr_open | #459 records the residual-add / `transformer.block.output` allocation-layout boundary with residual input and feed-forward branch output shape evidence; it keeps the Qwen3 Q8_0 appliance oracle as the gate and makes no speedup, packed-Q8 promotion, Q4/Q5, accelerator, server, Qwen3.5, or BitNet QK256 claim. |
