...
| SLM-CPU-086 | pr_open | #425 narrows the `model.final_norm.output` blocker to the exact public Candle LayerNorm/RMSNorm output-storage API gap before moving to residual-add or dense-math work. |
