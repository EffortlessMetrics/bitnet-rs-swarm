...
| SLM-CPU-086 | in_progress | Narrow the `model.final_norm.output` blocker to the exact public Candle LayerNorm/RMSNorm output-storage API gap before moving to residual-add or dense-math work. |
