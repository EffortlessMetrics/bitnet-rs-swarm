...
| M3MBA-025 | merged | #78 aligns M3 accepted-artifact metadata with the separate M4 strict-proof checklist without manufacturing M4 proof. |
...
Current focus: no post-handoff M3 Air slice is currently in progress. `M3MBA-025`
is merged and maps the accepted Microsoft 2B M3 reference-runner artifact
metadata to separate M4 receipt requirements without turning M3 evidence into
M4 proof.
...
`M3MBA-022`, `M3MBA-023`, `M3MBA-024`, `M3MBA-025`, and `M3MBA-026` are merged. The
...
`M3MBA-022`, `M3MBA-023`, `M3MBA-024`, `M3MBA-025`, and `M3MBA-026` are merged.
Performance follow-ups should remain scoped to the exact M3 Air host and
