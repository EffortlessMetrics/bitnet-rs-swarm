...
| intel-258v-platform | Intel 258V platform validation | LNL258V-CPU-SLOWPATH-REVIEW-001 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | Intel Arc A770 validation | A770-155 | OpenCL-first for native A770 proof. |
