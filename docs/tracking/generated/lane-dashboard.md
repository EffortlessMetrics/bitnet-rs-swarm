...
| apple-m4-post-excellence-hardening | Apple M4 post excellence hardening | M4-HARDEN-003 | Use ci/hardware/apple-m4-mac-mini/2026-05-22/m4-inference-excellence-completion-audit.json as the completed baseline evidence. |
