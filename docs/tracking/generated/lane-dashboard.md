...
| intel-258v-platform | Intel 258V platform validation | SWARM-LNL258V-BITNET-INTAKE-007 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | Intel Arc A770 validation | A770-006R | OpenCL-first for native A770 proof. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-BITNET-PERF-005 | CUDA visibility is not kernel execution. |
