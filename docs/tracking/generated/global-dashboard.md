...
| intel-258v-platform | SWARM-LNL258V-BITNET-INTAKE-006 | #45 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-006R | TBD | in_progress | none | OpenCL-first for native A770 proof. |
...
| nvidia-5070ti | CUDA-BITNET-PERF-005 | TBD | ready | none | CUDA visibility is not kernel execution. |
