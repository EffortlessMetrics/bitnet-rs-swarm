...
| intel-258v-platform | LNL258V-GOAL-AUDIT-021 | TBD | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-016 | #220 | pr_open | none | OpenCL-first for native A770 proof. |
...
| nvidia-5070ti | CUDA-MODEL-017A | TBD | in_progress | CUDA-MODEL-017 | CUDA visibility is not kernel execution. |
...
| slm-cpu | SLM-CPU-076 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
