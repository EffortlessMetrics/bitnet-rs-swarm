...
| intel-258v-platform | SWARM-LNL258V-GOAL-AUDIT-001 | #34 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-062 | TBD | in_progress | none | Do not edit BitNet QK256/I2_S kernels. |
