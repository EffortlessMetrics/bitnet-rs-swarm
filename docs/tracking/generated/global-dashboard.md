...
| intel-258v-platform | SWARM-LNL258V-GOAL-AUDIT-004 | TBD | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-010 | #80 | merged | none | OpenCL-first for native A770 proof. |
...
| slm-cpu | SLM-CPU-067 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
