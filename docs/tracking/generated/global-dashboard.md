...
| intel-258v-platform | LNL258V-GOAL-AUDIT-046 | #493 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-038 | #495 | pr_open | none | OpenCL-first for native A770 proof. |
...
| nvidia-5070ti | CUDA-MODEL-017 | #335 | blocked | CUDA-MODEL-018 | CUDA visibility is not kernel execution. |
...
| slm-cpu | SLM-CPU-090 | #483 | merged | none | Do not edit BitNet QK256/I2_S kernels. |
