...
| apple-m4-inference-excellence | M4-WORKLOAD-001 | #213 | pr_open | M4-TREND-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-GOAL-AUDIT-020 | TBD | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-015 | TBD | in_progress | none | OpenCL-first for native A770 proof. |
