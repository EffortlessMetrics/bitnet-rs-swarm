...
| apple-m4-post-excellence-hardening | M4-HARDEN-005 | TBD | proposed | M4-HARDEN-006 | Use ci/hardware/apple-m4-mac-mini/2026-05-22/m4-inference-excellence-completion-audit.json as the completed baseline evidence. |
...
| intel-258v-platform | LNL258V-CPU-PHASE-ATTRIBUTION-001 | #1599 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
