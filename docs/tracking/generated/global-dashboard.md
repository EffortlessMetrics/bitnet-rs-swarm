...
| intel-258v-platform | LNL258V-POWER-014 | #516 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-041 | #517 | pr_open | none | OpenCL-first for native A770 proof. |
