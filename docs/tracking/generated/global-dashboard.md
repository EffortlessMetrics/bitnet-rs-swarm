...
| apple-m4-post-excellence-hardening | M4-HARDEN-001 | TBD | in_progress | M4-HARDEN-002 | Use ci/hardware/apple-m4-mac-mini/2026-05-22/m4-inference-excellence-completion-audit.json as the completed baseline evidence. |
...
| slm-cpu | SLM-CPU-238 | #1031 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
