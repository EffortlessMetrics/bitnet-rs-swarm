...
| intel-258v-platform | LNL258V-CPU-MATCHED-CHECK-001 | #1593 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
