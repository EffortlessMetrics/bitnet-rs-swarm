...
| intel-258v-platform | LNL258V-POWER-011 | TBD | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-074 | #219 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
