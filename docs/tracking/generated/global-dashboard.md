...
| intel-258v-platform | LNL258V-GOAL-AUDIT-067 | #665 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-055 | #664 | pr_open | none | OpenCL-first for native A770 proof. |
