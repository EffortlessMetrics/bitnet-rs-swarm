...
| intel-258v-platform | SWARM-LNL258V-BITNET-INTAKE-009 | TBD | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-009 | TBD | ready | none | OpenCL-first for native A770 proof. |
