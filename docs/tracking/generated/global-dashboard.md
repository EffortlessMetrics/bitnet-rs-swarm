...
| intel-258v-platform | LNL258V-BITNET-INTAKE-006 | TBD | ready | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
