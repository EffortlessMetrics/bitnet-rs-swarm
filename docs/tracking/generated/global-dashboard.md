...
| intel-258v-platform | LNL258V-POWER-013 | #509 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-040 | #508 | pr_open | none | OpenCL-first for native A770 proof. |
...
| slm-cpu | SLM-CPU-091 | #507 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
