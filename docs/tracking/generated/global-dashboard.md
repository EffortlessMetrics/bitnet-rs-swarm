...
| intel-258v-platform | LNL258V-GOAL-AUDIT-057 | #580 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-045 | #574 | pr_open | none | OpenCL-first for native A770 proof. |
...
| slm-cpu | SLM-CPU-095 | #577 | merged | none | Do not edit BitNet QK256/I2_S kernels. |
