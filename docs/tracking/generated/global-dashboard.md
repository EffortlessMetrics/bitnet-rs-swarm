...
| apple-m4-inference-excellence | M4-ROUTE-MATRIX-001 | #196 | in_progress | M4-WORKLOAD-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-GOAL-AUDIT-019 | #206 | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-014 | #198 | merged | none | OpenCL-first for native A770 proof. |
...
| nvidia-5070ti | CUDA-MODEL-017 | TBD | ready | none | CUDA visibility is not kernel execution. |
...
| slm-cpu | SLM-CPU-074 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
