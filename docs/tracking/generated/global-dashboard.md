...
| apple-m3-macbook-air | M3MBA-027 | TBD | ready | M3MBA-028 | This is the Apple M3 MacBook Air lane, not the M4 Mac mini product, performance, or strict-proof lane. |
...
| apple-m4-post-excellence-hardening | M4-HARDEN-002 | TBD | proposed | M4-HARDEN-003 | Use ci/hardware/apple-m4-mac-mini/2026-05-22/m4-inference-excellence-completion-audit.json as the completed baseline evidence. |
...
| intel-258v-platform | LNL258V-BITNET-INTAKE-006 | TBD | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-158 | TBD | ready | none | OpenCL-first for native A770 proof. |
...
| slm-cpu | SLM-CPU-245 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
