...
| intel-258v-platform | LNL258V-CPU-SLOWPATH-REVIEW-001 | #1527 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
