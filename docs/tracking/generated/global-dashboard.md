...
| intel-258v-platform | SWARM-LNL258V-GOAL-AUDIT-004 | #97 | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
