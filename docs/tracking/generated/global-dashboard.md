...
| intel-258v-platform | LNL258V-ASK-009 | #743 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-116 | #742 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
