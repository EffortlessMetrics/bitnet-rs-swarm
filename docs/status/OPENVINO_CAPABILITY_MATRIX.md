...
| CPU slow-path and OpenVINO CPU decision boundary | `docs/research/lunar-lake-cpu-slow-path.md`, `docs/reviews/lunar-lake-cpu-route-decision.md`, [#1232](https://github.com/EffortlessMetrics/bitnet-rs-swarm/issues/1232); matched Rust GGUF CPU versus OpenVINO CPU comparison owned by [#1365](https://github.com/EffortlessMetrics/bitnet-rs-swarm/issues/1365); physical resident package closed by [#1280](https://github.com/EffortlessMetrics/bitnet-rs-swarm/issues/1280) / [#1334](https://github.com/EffortlessMetrics/bitnet-rs-swarm/pull/1334); diagnostic reviewable versus qualified status closed by [#1311](https://github.com/EffortlessMetrics/bitnet-rs-swarm/issues/1311) / [#1319](https://github.com/EffortlessMetrics/bitnet-rs-swarm/pull/1319); receipt-write and telemetry timing scope closed by [#1291](https://github.com/EffortlessMetrics/bitnet-rs-swarm/issues/1291) / [#1292](https://github.com/EffortlessMetrics/bitnet-rs-swarm/pull/1292) |
